...
export const products: Product[] = [
  ...
  { id: "ji1", name: "The OoohMy One", slug: "the-ooohmy-one-new", category: "Just In", categorySlug: "just-in", collection: "Fresh Trouble", emoji: "⚡", description: '"Your neighbours will know. That\'s their problem."', longDescription: "Premium vibrador com 10 modos de vibração, silicone médico, à prova d'água e ultra silencioso.", price: 79, sticker: "New ✨", features: ["10 modos de vibração", "Silicone médico", "À prova d'água IPX7", "Ultra silencioso", "USB recarregável"], images: ["⚡"], inStock: true, rating: 4.9, reviews: 342 },
  { id: "ji2", name: "Hot Stuff", slug: "hot-stuff-new", category: "Just In", categorySlug: "just-in", collection: "Fresh Trouble", emoji: "🌶️", description: '"Warning: may cause strong opinions and zero regrets."', longDescription: "Gel de aquecimento premium. Sensação crescente de calor que eleva cada toque.", price: 34, sticker: "New ✨", features: ["Efeito aquecimento", "Base aquosa", "Compatível com preservativos", "150ml"], images: ["🌶️"], inStock: true, rating: 4.4, reviews: 567 },
  { id: "ji3", name: "Long Distance", slug: "long-distance-new", category: "Just In", categorySlug: "just-in", collection: "Fresh Trouble", emoji: "📱", description: '"Love knows no distance. Neither does Bluetooth."', longDescription: "Controla o prazer do teu parceiro de qualquer lugar do mundo.", price: 109, sticker: "New Drop ✨", features: ["Controlo global via app", "Bluetooth ilimitado", "Chat integrado"], images: ["📱"], inStock: true, rating: 4.8, reviews: 234 },
  { id: "ji4", name: "Curious Kit", slug: "curious-kit-new", category: "Just In", categorySlug: "just-in", collection: "Fresh Trouble", emoji: "🔍", description: '"For the curious. No judgement."', longDescription: "Kit de exploração com 5 mini produtos para descobrir o que mais gostas.", price: 59, sticker: "New ✨", features: ["5 mini produtos", "Surpresa incluída", "Guia de descoberta"], images: ["🔍"], inStock: true, rating: 4.6, reviews: 234 },

  // SOLO
  { id: "so1", name: "The OoohMy One", slug: "the-ooohmy-one-solo", category: "Solo", categorySlug: "solo", collection: "No Audience Needed", emoji: "⚡", description: '"Your neighbours will know. That\'s their problem."', longDescription: "Premium vibrador com 10 modos de vibração, silicone médico, à prova d'água e ultra silencioso.", price: 79, sticker: "Fan Fave 🔥", features: ["10 modos de vibração", "Silicone médico", "À prova d'água IPX7", "Ultra silencioso"], images: ["⚡"], inStock: true, rating: 4.9, reviews: 342 },
  { id: "so2", name: "Whisper", slug: "whisper-solo", category: "Solo", categorySlug: "solo", collection: "No Audience Needed", emoji: "🤫", description: '"So quiet, your flatmate will never know."', longDescription: "O vibrador mais discreto do mercado. Motor sussurrante com potência surpreendente.", price: 59, features: ["Motor sussurrante", "7 modos", "Compacto", "Silicone premium"], images: ["🤫"], inStock: true, rating: 4.7, reviews: 189 },
  { id: "so3", name: "Thunder", slug: "thunder-solo", category: "Solo", categorySlug: "solo", collection: "No Audience Needed", emoji: "⛈️", description: '"Warning: May cause noise complaints."', longDescription: "Para quem não se importa com o que os vizinhos pensam. Potência máxima.", price: 99, originalPrice: 129, sticker: "Sale 🏷️", features: ["12 padrões intensos", "Potência máxima", "Dual motor"], images: ["⛈️"], inStock: true, rating: 4.8, reviews: 256 },
  { id: "so4", name: "Pocket Rocket", slug: "pocket-rocket-solo", category: "Solo", categorySlug: "solo", collection: "No Audience Needed", emoji: "🚀", description: '"Small but deadly. In a good way."', longDescription: "Cabe na bolsa, no bolso, em qualquer lugar. Tamanho mini, prazer maxi.", price: 39, features: ["Ultra compacto", "5 modos", "Discreto", "Travel-friendly"], images: ["🚀"], inStock: true, rating: 4.5, reviews: 412 },

  // PUSH IT (kink & sensation)
  { id: "pi1", name: "Starter Ropes", slug: "starter-ropes-push", category: "Push It", categorySlug: "push-it", collection: "A Little Further", emoji: "🪢", description: '"Learn the ropes. Literally."', longDescription: "Kit de cordas de seda para iniciantes. Suaves na pele, fortes o suficiente.", price: 39, sticker: "Starter 🗝️", features: ["Cordas de seda", "2x 5 metros", "Guia de nós incluído"], images: ["🪢"], inStock: true, rating: 4.5, reviews: 189 },
  { id: "pi2", name: "The Director's Kit", slug: "directors-kit-push", category: "Push It", categorySlug: "push-it", collection: "A Little Further", emoji: "🎬", description: '"Action! ...and cut."', longDescription: "Kit completo de bondage premium: algemas acolchoadas, venda de seda, collar, leash e paddle.", price: 159, sticker: "Premium 👑", features: ["6 peças", "Couro vegan", "Maleta incluída"], images: ["🎬"], inStock: true, rating: 4.9, reviews: 145 },
  { id: "pi3", name: "Hot Stuff", slug: "hot-stuff-push", category: "Push It", categorySlug: "push-it", collection: "A Little Further", emoji: "🌶️", description: '"Warning: may cause strong opinions and zero regrets."', longDescription: "Gel de aquecimento premium. Sensação crescente de calor.", price: 34, sticker: "Hot 🔥", features: ["Efeito aquecimento", "Base aquosa", "Compatível com preservativos"], images: ["🌶️"], inStock: true, rating: 4.4, reviews: 567 },
  { id: "pi4", name: "Silk Blindfold", slug: "silk-blindfold-push", category: "Push It", categorySlug: "push-it", collection: "A Little Further", emoji: "🎭", description: '"What you can\'t see won\'t hurt you. Probably."', longDescription: "Venda de seda dupla face. Bloqueia 100% da luz.", price: 24, features: ["Seda dupla face", "100% blackout", "Elástico ajustável"], images: ["🎭"], inStock: true, rating: 4.6, reviews: 456 },

  // PLAYTIME (accessories & play)
  { id: "pt1", name: "The Together", slug: "the-together-play", category: "Playtime", categorySlug: "playtime", collection: "You Make the Rules", emoji: "💑", description: '"Two is always better. We rest our case."', longDescription: "Desenhado para casais que querem elevar a experiência.", price: 129, sticker: "Best Seller 👑", features: ["Dupla estimulação", "Controlo via app", "Vibração sincronizada"], images: ["💑"], inStock: true, rating: 4.9, reviews: 523 },
  { id: "pt2", name: "Date Night", slug: "date-night-play", category: "Playtime", categorySlug: "playtime", collection: "You Make the Rules", emoji: "🍷", description: '"Netflix and... oh."', longDescription: "O kit perfeito para noites especiais.", price: 89, features: ["Kit completo", "Vela de massagem incluída", "Guia de ideias"], images: ["🍷"], inStock: true, rating: 4.6, reviews: 178 },
  { id: "pt3", name: "The Set-Up", slug: "the-set-up-play", category: "Playtime", categorySlug: "playtime", collection: "You Make the Rules", emoji: "🗝️", description: '"Everything you need. Nothing embarrassing. Much."', longDescription: "Kit iniciante completo: mini vibrador, lubrificante natural, guia de exploração.", price: 99, sticker: "Starter 🗝️", features: ["Mini vibrador", "Lubrificante 50ml", "Guia ilustrado"], images: ["🗝️"], inStock: true, rating: 4.8, reviews: 678 },
  { id: "pt4", name: "Ring King", slug: "ring-king-play", category: "Playtime", categorySlug: "playtime", collection: "You Make the Rules", emoji: "👑", description: '"Wear the crown."', longDescription: "Anel vibratório com estimulação dual. Silicone elástico, 10 modos de vibração.", price: 44, features: ["Vibração dual", "Silicone elástico", "10 modos", "USB recarregável"], images: ["👑"], inStock: true, rating: 4.8, reviews: 323 },
];

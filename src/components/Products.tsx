  ...
  return (
    <div id="best-sellers" className="bg-dark border-t-[5px] border-dark border-b-[5px] border-b-primary px-6 lg:px-12 py-20 lg:py-24">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-4 border-[3px] border-white/10">
          {products.map((product, index) => (
            <Link
              key={product.slug}
              to={`/category/${product.categorySlug}/product/${product.slug}`}
              className={`group relative overflow-hidden transition-transform hover:-translate-x-1 hover:-translate-y-1 hover:-rotate-[0.5deg] hover:z-[2] flex flex-col justify-end aspect-square no-underline ${index % 4 !== 3 ? "border-r-[3px] border-white/10" : ""}`}
            >

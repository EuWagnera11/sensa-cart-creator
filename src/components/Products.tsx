...
const Products = () => {
  ...
  return (
    <div id="best-sellers" className="bg-black border-t-[5px] border-black border-b-[5px] border-b-black px-6 lg:px-12 py-20 lg:py-24">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 rounded-sm bg-black" style={{ boxShadow: "4px 4px 0 rgba(0,0,0,.4)" }}>
          {products.map((product, index) => (
            <Link
              key={product.slug}
              to={`/category/${product.categorySlug}/product/${product.slug}`}
              className={`group relative overflow-hidden transition-transform hover:-translate-x-1 hover:-translate-y-1 hover:-rotate-[0.5deg] hover:z-[2] flex flex-col justify-end aspect-square no-underline`}
            >

...
const rightBtnWrapClasses = "absolute bottom-8 sm:bottom-8 left-0 right-0 flex justify-center z-10";
const btnBase = "border-[3px] border-dark rounded-sm px-5 py-2 text-[0.75rem] sm:px-9 sm:py-3 sm:text-[1.05rem] font-display italic font-bold shadow-[4px_4px_0_hsl(var(--dark))] group-hover:translate-x-[-2px] group-hover:translate-y-[-2px] group-hover:shadow-[7px_7px_0_hsl(var(--dark))] transition-all inline-block";

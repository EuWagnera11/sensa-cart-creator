...
const MarqueeBand = () => (
  <div className="bg-dark py-3.5 overflow-hidden border-y-[3px] border-primary <div className="bg-dark py-3.5 overflow-hidden border-y-[3px] border-primary shadow-[0_4px_0_0_hsl(var(--dark))]">">
